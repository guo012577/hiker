    ...
    d.unshift({
        ...
        url: $('hiker://empty#noRecordHistory#').rule(() => {
            ...
            d.push({
                title: '打开编辑',
                url: $().lazyRule(() => {
                    return 'editFile://hiker://files/rules/xyq/hikermovie.json'
                }),
                col_type: 'text_2'
            });
            d.push({
...
function omlazy() {
    ...
    try {
        ...
        } else if (/wwgz|wuwuabc|aiyy|shigys|v\.t-ui|dadou|kykyy|oftens|wwys|nkvod|7xdy/.test(myurl)) {
            //直接网页嗅探

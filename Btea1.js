...
var FhImage = $.getImage('http://123.56.105.145/tubiao/3d/314.png');
    ...
    let sel_title = ['通免1', '通免2','通免3','通免4','通免5','通免6','通免7', '香免'].map((it) => {
...
try{
   ...
   //log('html1')         
    ...
    //log('html='+html)         
    if(getItem("通免")=="通免1"){def_lazy=config.通免1}else if(getItem("通免")=="通免2"){def_lazy=config.通免2}if(getItem("通免")=="通免3"){def_lazy=config.通免3}if(getItem("通免")=="通免4"){def_lazy=config.通免4}if(getItem("通免")=="通免5"){def_lazy=config.通免5}if(getItem("通免")=="通免6"){def_lazy=config.通免6}if(getItem("通免")=="通免7"){def_lazy=config.通免7};
    lazy=lazy||def_lazy;
    /*

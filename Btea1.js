...
putVar('小程序名', MY_RULE.title);
  ...
  if(getItem("shunsou","on")=="on"){ 
       ...
       if(fileExist(本地) == false) {
			var 远程x5 = request('https://htmlpreview.github.io/?https://github.com/guo012577/hiker/blob/main/%E9%A1%BA%E6%90%9C.html');
...
//log('html='+html) 
if(getItem("通免")=="通免"){def_lazy = config.通免}else if(getItem("通免")=="道长通免"){def_lazy=config.道长通免}else if(getItem("通免")=="香免"){def_lazy=config.香免} ;
lazy=lazy||def_lazy;

...
function getHtml(url, headers, mode, proxy) {
    ...
    if (!htmlT || /error code: 1015|无法访问目标地址|__cf_chl_tk|Protected by cdndefend|Just a moment/.test(htmlT)) {
        ...
        if ((needFirecrawl || (htmlT && /error code: 1015|__cf_chl_tk|cf-error-details|无法访问目标地址|Protected by cdndefend|Just a moment/.test(htmlT))) &&  !(htmlT && htmlT.includes('Firecrawl'))){
